                ...
                <Accordion flush data-bs-theme="dark" className="techBGC">
                    <Accordion.Item eventKey="0">
                        ...
                        <Accordion.Body>
                            <Accordion flush>
                                <Accordion.Item eventKey="0">
                                    <Accordion.Header>Control Stick</Accordion.Header>
                                    <Accordion.Body>
